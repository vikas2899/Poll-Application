    ...
    return (
        <Container>
            ...
            <PollContainer>
                <Box>
                    <Ask>
                        <AskInput placeholder="Ask ..." onChange={(e) => handleAsk(e)} value={ask}></AskInput>
                    </Ask>
                    <ChoiceContainer>
                        <Choices>
                            <Choice placeholder="Option 1" value={optionOne} onChange={(e) => handleOptions(e, 1)}></Choice>
                        </Choices>
                        <Choices>
                            <Choice placeholder="Option 2" value={optionTwo} onChange={(e) => handleOptions(e, 2)}></Choice>
                        </Choices>
                        {optionNumber >= 3 ? <Choices>
                            <Choice placeholder="Option 3" value={optionThree} onChange={(e) => handleOptions(e, 3)}></Choice>
                        </Choices> : null}
                        {optionNumber >= 4 ? <Choices>
                            <Choice placeholder="Option 4" value={optionFour} onChange={(e) => handleOptions(e, 4)}></Choice>
                        </Choices> : null}
                        {optionNumber < 4 ? <Button onClick={handleClick}><AddIcon /></Button> : null}
                    </ChoiceContainer>
                </Box>
                <Box>
                    <VisibilityContainer>
                    ...
                    <MessageContainer>
                        {errorMessage !== "" ? <Message>{ errorMessage }</Message> : error ? <Message>Something went Wrong !!</Message>  : currentPoll ? <Message>Poll Created Successfully !</Message> : null}
                    </MessageContainer>
                </Box>
            </PollContainer>
        </Container>
