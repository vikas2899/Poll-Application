    ...
    return (
        <Container active={props.active}>
            <Wrapper onClick={() => setOpen(true)}>
                ...
                <InfoContainer>
                    <Badge text={props.active ? `Active` : `Inactive`} color={ props.active ? "green" : "red"} />
                    <Badge text={props.visibility} color={ props.visibility === "public" ? "blue" : "yellow"} />
                </InfoContainer>
            </Wrapper>
            <Modal isOpen={isOpen} onRequestClose={() => setOpen(false)} style={{overlay : {zIndex: 1000}}}>
                <ModalContent setOpen={setOpen} ask={props.ask} opt1={props.opt1}
                    opt2={ props.opt2}
                    opt3={ props.opt3}
                    opt4={props.opt4}
